        ...
        <div className="py-24 sm:py-16">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <span className="inline-flex rounded-full bg-pink-400/10 px-3 py-1 text-sm font-semibold leading-6 text-pink-300 ring-1 ring-inset ring-pink-400/20 mb-2">
                {session ? (
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-x-6 gap-y-6 sm:gap-y-0">
                {session ? (
                  <div className="flex flex-col sm:flex-row sm:justify-center gap-4 sm:gap-8 w-2/3">
                    ...
                    <button
                      type="button"
                      className="rounded-md bg-pink-400 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-pink-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-300"
